...
import com.example.dts_1.User_Ui.incoming.user_incoming_PlaceholderContent.PlaceholderItem;
...
import com.example.dts_1.databinding.UserIncomingItemBinding;
 ...
 */
public class user_incoming_RecyclerViewAdapter extends RecyclerView.Adapter<user_incoming_RecyclerViewAdapter.ViewHolder> {

    private final List<PlaceholderItem> mValues;
    private OnItemClickListener listener;
    public user_incoming_RecyclerViewAdapter(List<PlaceholderItem> items, OnItemClickListener listener) {
        mValues = items;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(UserIncomingItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
...
//        public final TextView mIdView;
        ...
        public ViewHolder(UserIncomingItemBinding binding) {
