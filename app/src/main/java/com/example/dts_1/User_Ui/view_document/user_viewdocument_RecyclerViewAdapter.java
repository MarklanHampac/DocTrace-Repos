...
import com.example.dts_1.User_Ui.view_document.user_viewdocument_PlaceholderContent.PlaceholderItem;
...
public class user_viewdocument_RecyclerViewAdapter extends RecyclerView.Adapter<user_viewdocument_RecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(UserViewdocumentItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(UserViewdocumentItemBinding binding) {
